...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "0qCdIEtamWtYzmdK4tN92EyZl";       // Change this
	public static final String REST_CONSUMER_SECRET = "j0ppZhQdnLEdJ9p33MrIBsT4iHw7k3S7L21IeW53MRYq0XYSeX"; // Change this
	...
	public void favTweet(Tweet tweet, AsyncHttpResponseHandler handler) {
        ...
        RequestParams params = new RequestParams();
        params.put("id", Long.toString(tweet.getUid()));
        client.post(apiUrl, params, handler);
    }
